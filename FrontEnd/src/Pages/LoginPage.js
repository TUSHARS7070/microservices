...
const LoginPage = () => {
  ...
  reverseOrder={false}
/>
        <h1 className="text-[30px] text-[#0606060] font-serif">TUSHAR ENTERPRISES</h1>

        <div className="w-fil flex flex-col w-[55%]">
          <div className="w-flex flex flex-col mb-5">
            <h3 className="text-3xl font-semibold mb-2">Login</h3>
            <p className="text-base mb-2">Welcome Back to TUSHAR ENTERPRISES - Your Home, Your Way</p>
          </div>
