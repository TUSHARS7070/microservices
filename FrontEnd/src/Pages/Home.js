    ...
    <div>
      ...
      <div
        ...
        <div className=' ml-[100px] flex flex-row space-x-4 '>
            ...
            <h2 className='text-yellow-400 brightness-200 font-sans text-xl uppercase tracking-widest font-bold'>Welcome to TUSHAR ENTERPRISES</h2>
        </div>
        ...
        <p className='text-white brightness-100 font-thin'>Dive into the essence of quality with our curated collection, where each item is meticulously selected with your needs and preferences in mind. Whether you are in search of timeless classics or innovative solutions, TUSHAR ENTERPRISES is your reliable partner in crafting spaces that authentically embody your unique essence. Explore our handpicked treasures and elevate your surroundings with style and purpose.</p>
        </div>
